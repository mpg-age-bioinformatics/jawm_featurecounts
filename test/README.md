...
featurecounts.py;test;./test/yaml/test.yaml;"Main workflow test";ce67151f2a16c1ee96e65c5eec6e7b07288f003fb3affce6f08568cf11a1525f
```
...
```
- scope: hash
  include: ./test/test-output/featurecounts.txt
